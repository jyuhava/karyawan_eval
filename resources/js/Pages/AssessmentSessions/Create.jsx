...
export default function Create({ employees, evaluationInstruments }) {
    console.log('CREATE COMPONENT LOADED');
    console.log('Employees:', employees);
    console.log('Evaluation Instruments:', evaluationInstruments);
    ...
    const handleSubmit = (e) => {
        ...
        e.preventDefault();
        console.log('POSTING TO:', route('assessment-sessions.store'));
        post(route('assessment-sessions.store'), {
            onStart: () => console.log('POST STARTED'),
            onSuccess: (page) => console.log('POST SUCCESS:', page),
            onError: (errors) => console.log('POST ERROR:', errors),
            onFinish: () => console.log('POST FINISHED')
        });
    };

    const handleEducationChange = (checked) => {
        console.log('Education checkbox changed:', checked);
    ...
    return (
        <AdminLayout title="Buat Assessment Session">
            <Head title="Buat Assessment Session" />

            <div className="py-3">
                <div className="bg-white shadow-sm rounded-lg">
                    <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                        <h3 className="text-lg font-medium text-gray-900">Buat Assessment Session Baru</h3>
                        <Link
